...
if (isset($conn) && $conn) {
    if (isset($_SESSION['session_id'])) {
        ...
        $sess_query = pg_query_params($conn, "SELECT time FROM session_info WHERE id=$1", [$sess_id]);
...
<input type="hidden" name="session_id" value="<?php echo isset($_SESSION['session_id']) ? htmlspecialchars($_SESSION['session_id'], ENT_QUOTES, 'UTF-8') : ''; ?>">
